...
тут странное поведение ogen: если мы указали эндпоинт с одной ошибкой, то ErrorResponse будет удовлетворять интерфейсу response, но если 
...
(или сделать обертку для pgx.Pool и транзакций)
